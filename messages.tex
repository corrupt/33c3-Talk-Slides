...
\cbb{Time#1}{4}{} \cbb{mDarkTeal#1}{4}{Flags}%
...
\begin{bytefield}{32}
	...
	%\begin{rightwordgroup}{\makebox[0pt][l]{Body}\phantom{Header}}
		\cwb[rlb]{Ciphertext}{3}{Ciphertext} 
	%\end{rightwordgroup}
\end{bytefield}
...
\begin{bytefield}{32}
	...
	\cwb[rlb]{Ciphertext}{3}{\raisebox{2em}{Threema Client-to-Server Ciphertext}} \\
\end{bytefield}
...
\begin{bytefield}{32}
	...
	\begin{rightwordgroup}{Ciphertext}
		...
		\cbb[rlb]{String}{17}{\raisebox{2em}{Text}} & \cbb{Padding}{15}{Variable-length Padding}
	\end{rightwordgroup}\\
\end{bytefield}
...
\section*{Image Message}
	...
	\begin{bytefield}{32}
		...
		\begin{rightwordgroup}{Ciphertext}
			...
			\cbb{Key}{21}{} & \cbb[tlr]{Padding}{11}{} \\
			\cwb[lbr]{Padding}{1}{Variable-length Padding}
		\end{rightwordgroup}\\
	\end{bytefield}
...
\begin{bytefield}{32}
	...
	\end{rightwordgroup}\\
	\begin{rightwordgroup}{Ciphertext}
		\cbb{MsgType}{1}{\rotatebox{90}{\scriptsize\bfseries 0x02}} & \cbb{mDarkTeal}{2}{\rotatebox{45}{\tiny 0xFFFF}}
		\cbb{Blob}{16}{Blob ID} &
		\cbb{Size}{4}{Size} & \cbb{Key}{9}{Key} \\
		\cbb{Key}{23}{} & \cbb[lrt]{Padding}{9}{} \\
		\cbb[rlb]{Padding}{32}{Variable-length Padding}
	\end{rightwordgroup}\\
\end{bytefield}
...
\emptybox[]{2} & \cbb[lr]{mDarkTeal}{20}{$\longleftarrow$ \quad Length \quad $\longrightarrow$} 
\end{bytefield}
