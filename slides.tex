...
\begin{frame}
	...
	\begin{overlayarea}{\textwidth}{\textheight}
		\begin{itemize}
			\item<2-> In asymmetric cryptography, it is always clear who sent a message, once the protocol is broken on either side\pdfcomment{now our hacker has managed to break into Bob's phone and can look at the messages}
		...
		\-\\
		\begin{center}
			\only<2>{\includegraphics[width=.8\textwidth]{img/no-deniability.pdf}}
