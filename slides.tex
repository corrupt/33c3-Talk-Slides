...
\begin{frame}
	...
	Threema
	\begin{itemize}
		\item Gained polularity in Germany after Facebook purchased WhatsApp
...
\begin{itemize}
	...
	\item Find out how protocol is designed
		\begin{enumerate}
			\item Understand handshakek
			\item Understand protocol
			\item decipher messages
		\end{enumerate}
\end{itemize}
\alert{Positive sidenote}: Threema had released a security whie paper early on
\end{frame}
...
\begin{frame}
	...
	\includegraphics[page=6,clip,trim={2.6cm 7.5cm 3.2cm 1cm},width=\textwidth]{out/messages.pdf}
\end{frame}
