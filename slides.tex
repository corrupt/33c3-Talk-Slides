...
\begin{frame}
	...
	\begin{tabular}{@{}ll}
		Beamer Theme: & \alert{\hyperlink{https://github.com/matze/mtheme}{Metropolis}} by Matthias volgelsang\\
		Color Theme: & \alert{\hyperlink{https://github.com/rchurchley/beamercolortheme-owl}{Owl}} by Ross Chirchley \\
	\end{tabular}\\[3em]
